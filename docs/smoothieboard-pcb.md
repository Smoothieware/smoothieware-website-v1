...
This page shows detailed views of the Smoothieboard printed circuit board (PCB) for reference and design purposes.

{::nomarkdown}
<sl-alert variant="neutral" open>
  <sl-icon slot="icon" name="info-circle"></sl-icon>
  <strong>PCB Reference Images:</strong> These images show the detailed layout of the Smoothieboard PCB from various angles.
  <br><br>
  Useful for understanding component placement, routing, and for designing enclosures or modifications.
</sl-alert>
{:/nomarkdown}
