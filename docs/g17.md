...
Smoothie starts in the G17 mode (the default plane is the XY plane). However, if you changed the plane with the [G18](g18) or [G19](g19) commands, you can come back to the "normal" plane with this command.
