...
Smoothie Edge-0b3e620 and later now pays attention to config option {::nomarkdown}<setting v1="planner_queue_size" v2="planner.planner_queue_size"></setting>{:/nomarkdown}. [Read more…](blog_7)
