...
**CO2 Lasers:**
- **Wavelength**: <raw>10.6 micrometers (μm)</raw>, in the infrared spectrum (invisible to human eye)
- **Power levels**: Desktop cutters typically <raw>40-150W</raw>
...
**Diode Lasers:**
- **Wavelength**: <raw>405-450nm</raw> (blue/violet, visible) or <raw>808-980nm</raw> (infrared, invisible)
- **Power levels**: Typically <raw>5-40W</raw> optical output
...
**Fiber Lasers:**
- **Wavelength**: Typically <raw>1064nm</raw> (infrared, invisible to human eye)
- **Power levels**: <raw>20W+</raw> for marking, <raw>100W+</raw> for cutting
...
<sl-alert variant="warning" open>
  ...
  Many laser cutters have a visible red dot pointer for alignment. This is NOT the cutting laser. CO2 lasers (<raw>10.6μm</raw>) and fiber lasers (<raw>1064nm</raw>) are completely invisible. Some IR diode lasers (<raw>808-980nm</raw>) are also invisible. Never assume you can see the dangerous beam.
</sl-alert>
{:/nomarkdown}
...
- Keep a **fire extinguisher** (<raw>CO2</raw> or dry powder type) within immediate reach
...
- Use fire extinguisher if flames do not self-extinguish within <raw>2-3 seconds</raw>
...
- After cutting completes, allow ventilation to run <raw>30-60 seconds</raw> before opening lid
...
- Produces **chlorine gas** (<raw>Cl₂</raw>) - highly toxic, can be fatal
- Produces **hydrochloric acid** (<raw>HCl</raw>) - corrosive to machine components and lungs
- Damages optics, electronics, and metal parts through acid corrosion
- **Chemistry**: When heated, PVC releases chlorine which combines with moisture to form <raw>HCl</raw>

**ABS Plastic**:
- Produces **cyanide gas** (<raw>HCN</raw>) - extremely toxic, can be fatal in small quantities
...
- **CO2 lasers**: Metals reflect <raw>10.6μm</raw> wavelength back into tube, destroying it
...
- Look up the material's <raw>MSDS</raw> (Material Safety Data Sheet)
- Check if it contains chlorine, fluorine, or other halogens
- Verify it's not reflective to <raw>10.6μm</raw> wavelength
...
- **CO2 laser power supplies** operate at approximately **40,000 volts** (<raw>40kV</raw>) to excite the CO2 gas
...
- **Diode lasers** typically use <raw>12-48V</raw> DC power supplies
...
- Use <raw>GFCI</raw> (ground fault circuit interrupter) protection where possible

{::nomarkdown}
<sl-alert variant="danger" open>
  <sl-icon slot="icon" name="lightning-charge"></sl-icon>
  <strong>Electrical Safety Warning:</strong><br><br>
  <strong>CO2 lasers:</strong> If you are not qualified to work with high voltage electrical systems (<raw>40kV</raw>), contact a professional electrician or laser technician. Do not attempt repairs on laser power supplies or CO2 tubes.<br><br>
...
- **<raw>EN 60825-1</raw> (<raw>IEC 60825-1</raw>)**: International laser equipment safety standard
- **<raw>21 CFR 1040</raw>**: U.S. FDA laser product performance standards
- **<raw>ANSI Z136</raw> series**: American National Standards for safe laser use
- **<raw>ISO 11553</raw>**: Laser processing machine safety standards
