...
This page provides detailed information about migrating to Smoothie, including configuration format differences, choosing the right version, and common pitfalls to avoid.
