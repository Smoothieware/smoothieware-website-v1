    ...
    <tbody>
        <tr>
            ...
            <td class="description-cell">
                ...
                <p>In v2, set <setting v2="zprobe.leveling"></setting> to <raw>"delta grid"</raw>.</p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="description-cell">
                <p>Automatically homes all axes before running the <gcode>G31</gcode> grid probing sequence.</p>
        ...
        <tr>
            ...
            <td class="description-cell">
                <p>Automatically saves the <mcode>M375</mcode> command to config-override when <mcode>M500</mcode> is issued, causing the grid to be loaded from <raw>/sd/delta.grid</raw> on boot and compensation to be enabled automatically.</p>
        ...
        <tr>
            ...
            <td class="description-cell"><strong>DEPRECATED</strong> - This setting is no longer supported and will produce an error if used. For square or rectangular beds, use the <raw>rectangular-grid</raw> strategy instead of <raw>delta-grid</raw>.</td>
        </tr>
    </tbody>
</table>
{:/nomarkdown}
