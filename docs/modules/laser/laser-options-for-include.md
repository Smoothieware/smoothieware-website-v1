...
| <setting v1="laser_module_pwm_pin" v2="laser.pwm_pin"></setting> | `nc` | This pin will control the laser. Pulse width will be modulated to vary power output (PWM). Note: PWM is available only on pins <pin>2.0</pin> to <pin>2.5</pin>, <pin>1.18</pin>, <pin>1.20</pin>, <pin>1.21</pin>, <pin>1.23</pin>, <pin>1.24</pin>, <pin>1.26</pin>, <pin>3.25</pin> and <pin>3.26</pin>. |
