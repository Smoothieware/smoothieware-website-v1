...
| `alpha_angle` | 0.0 / 30.0 | Angle by which the plane is rotated. For `rotatable_cartesian` arm solution: default is 0.0. For `experimental_delta` arm solution: default is 30.0. |
