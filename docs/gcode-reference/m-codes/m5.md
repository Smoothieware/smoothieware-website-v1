...
<!-- learning-diagram:23-m5-spindle-stop -->
{::nomarkdown}
<figure id="learning-diagram-23-m5-spindle-stop" style="clear: both; max-width: 960px; margin: 2rem auto; scroll-margin-top: 16vh;">
  <a href="/images/learning-diagrams/23-m5-spindle-stop.svg">
    <img src="/images/learning-diagrams/23-m5-spindle-stop.svg" alt="M5 stops the spindle: Use M5 before changing tools and when the job is complete." loading="lazy" decoding="async" style="display: block; width: 100%; height: auto; border-radius: 0.1rem;"/>
  </a>
  <figcaption style="margin-top: 0.6rem; font-size: 0.92rem; opacity: 0.82; text-align: center;">M5 stops the spindle <a href="#learning-diagram-23-m5-spindle-stop" aria-label="Permanent link to M5 stops the spindle" style="margin-left: 0.35rem; text-decoration: none;">#</a></figcaption>
</figure>
{:/nomarkdown}
