...
<figure id="learning-diagram-23-m5-spindle-stop" style="clear: both; max-width: 960px; margin: 2rem auto; scroll-margin-top: 16vh;">
  <a href="/images/learning-diagrams/23-m5-spindle-stop.svg">
    <img src="/images/learning-diagrams/23-m5-spindle-stop.svg" alt="M5 spindle stop: Draining motion before stop supports safe tool changes." style="display: block; width: 100%; height: auto; border-radius: 0.75rem;"/>
  </a>
  <figcaption style="margin-top: 0.6rem; font-size: 0.92rem; opacity: 0.82; text-align: center;">Visual guide: Draining motion before stop supports safe tool changes.</figcaption>
</figure>
{:/nomarkdown}
