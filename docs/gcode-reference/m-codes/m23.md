...
<figure id="learning-diagram-20-m23-select-file" style="clear: both; max-width: 960px; margin: 2rem auto; scroll-margin-top: 16vh;">
  <a href="/images/learning-diagrams/20-m23-select-file.svg">
    <img src="/images/learning-diagrams/20-m23-select-file.svg" alt="M23 file selection: Selection is state, not execution." style="display: block; width: 100%; height: auto; border-radius: 0.75rem;"/>
  </a>
  <figcaption style="margin-top: 0.6rem; font-size: 0.92rem; opacity: 0.82; text-align: center;">Visual guide: Selection is state, not execution.</figcaption>
</figure>
{:/nomarkdown}
