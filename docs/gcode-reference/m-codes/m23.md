...
{::nomarkdown}
<figure id="learning-diagram-20-m23-select-file" style="scroll-margin-top: 16vh; "clear: both; max-width: 960px; margin: 2rem auto;">
  ...
  <figcaption style="margin-top: 0.6rem; color: #526174; font-size: 0.92rem; text-align: center;">Visual guide: Selection is state, not execution.</figcaption>
</figure>
{:/nomarkdown}
