...
{::nomarkdown}
<figure id="learning-diagram-18-m20-sd-list" style="scroll-margin-top: 16vh; "clear: both; max-width: 960px; margin: 2rem auto;">
  <a href="/images/learning-diagrams/18-m20-sd-list.svg">
    <img src="/images/learning-diagrams/18-m20-sd-list.svg" alt="M20 SD listing: The controller returns the files it sees on the card." style="display: block; width: 100%; height: auto; border-radius: 0.75rem;"/>
  </a>
  <figcaption style="margin-top: 0.6rem; color: #526174; font-size: 0.92rem; text-align: center;">Visual guide: The controller returns the files it sees on the card.</figcaption>
</figure>
{:/nomarkdown}
