...
<figure id="learning-diagram-18-m20-sd-list" style="clear: both; max-width: 960px; margin: 2rem auto; scroll-margin-top: 16vh;">
  ...
  <figcaption style="margin-top: 0.6rem; font-size: 0.92rem; opacity: 0.82; text-align: center;">Visual guide: The controller returns the files it sees on the card.</figcaption>
</figure>
{:/nomarkdown}
