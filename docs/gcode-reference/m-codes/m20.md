...
<!-- learning-diagram:18-m20-sd-list -->
{::nomarkdown}
<figure id="learning-diagram-18-m20-sd-list" style="clear: both; max-width: 960px; margin: 2rem auto; scroll-margin-top: 16vh;">
  <a href="/images/learning-diagrams/18-m20-sd-list.svg">
    <img src="/images/learning-diagrams/18-m20-sd-list.svg" alt="M20 lists the SD card contents: Smoothie sends one file name per line to the connected host." loading="lazy" decoding="async" style="display: block; width: 100%; height: auto; border-radius: 0.1rem;"/>
  </a>
  <figcaption style="margin-top: 0.6rem; font-size: 0.92rem; opacity: 0.82; text-align: center;">M20 lists the SD card contents <a href="#learning-diagram-18-m20-sd-list" aria-label="Permanent link to M20 lists the SD card contents" style="margin-left: 0.35rem; text-decoration: none;">#</a></figcaption>
</figure>
{:/nomarkdown}
