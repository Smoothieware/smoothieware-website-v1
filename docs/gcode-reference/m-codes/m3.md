...
<figure id="learning-diagram-22-m3-spindle" style="clear: both; max-width: 960px; margin: 2rem auto; scroll-margin-top: 16vh;">
  ...
  <figcaption style="margin-top: 0.6rem; font-size: 0.92rem; opacity: 0.82; text-align: center;">Visual guide: Motion synchronization precedes spindle output.</figcaption>
</figure>
{:/nomarkdown}
