...
<!-- learning-diagram:22-m3-spindle -->
{::nomarkdown}
<figure id="learning-diagram-22-m3-spindle" style="clear: both; max-width: 960px; margin: 2rem auto; scroll-margin-top: 16vh;">
  <a href="/images/learning-diagrams/22-m3-spindle.svg">
    <img src="/images/learning-diagrams/22-m3-spindle.svg" alt="M3 starts the spindle at the S speed: M3 S1000 commands clockwise rotation at 1000 revolutions per minute." loading="lazy" decoding="async" style="display: block; width: 100%; height: auto; border-radius: 0.1rem;"/>
  </a>
  <figcaption style="margin-top: 0.6rem; font-size: 0.92rem; opacity: 0.82; text-align: center;">M3 starts the spindle at the S speed <a href="#learning-diagram-22-m3-spindle" aria-label="Permanent link to M3 starts the spindle at the S speed" style="margin-left: 0.35rem; text-decoration: none;">#</a></figcaption>
</figure>
{:/nomarkdown}
