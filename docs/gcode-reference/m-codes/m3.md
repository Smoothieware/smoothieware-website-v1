...
{::nomarkdown}
<figure id="learning-diagram-22-m3-spindle" style="scroll-margin-top: 16vh; "clear: both; max-width: 960px; margin: 2rem auto;">
  <a href="/images/learning-diagrams/22-m3-spindle.svg">
    <img src="/images/learning-diagrams/22-m3-spindle.svg" alt="M3 spindle start: Motion synchronization precedes spindle output." style="display: block; width: 100%; height: auto; border-radius: 0.75rem;"/>
  </a>
  <figcaption style="margin-top: 0.6rem; color: #526174; font-size: 0.92rem; text-align: center;">Visual guide: Motion synchronization precedes spindle output.</figcaption>
</figure>
{:/nomarkdown}
