...
<!-- learning-diagram:15-g30-probe-cycle -->
{::nomarkdown}
<figure id="learning-diagram-15-g30-probe-cycle" style="clear: both; max-width: 960px; margin: 2rem auto; scroll-margin-top: 16vh;">
  <a href="/images/learning-diagrams/15-g30-probe-cycle.svg">
    <img src="/images/learning-diagrams/15-g30-probe-cycle.svg" alt="G30 moves Z until the probe triggers: Smoothie reports the distance travelled, or sets Z when the command includes Z." loading="lazy" decoding="async" style="display: block; width: 100%; height: auto; border-radius: 0.1rem;"/>
  </a>
  <figcaption style="margin-top: 0.6rem; font-size: 0.92rem; opacity: 0.82; text-align: center;">G30 moves Z until the probe triggers <a href="#learning-diagram-15-g30-probe-cycle" aria-label="Permanent link to G30 moves Z until the probe triggers" style="margin-left: 0.35rem; text-decoration: none;">#</a></figcaption>
</figure>
{:/nomarkdown}
