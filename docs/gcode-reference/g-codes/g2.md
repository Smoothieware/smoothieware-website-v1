...
<figure id="learning-diagram-03-g2-clockwise-arc" style="clear: both; max-width: 960px; margin: 2rem auto; scroll-margin-top: 16vh;">
  <a href="/images/learning-diagrams/03-g2-clockwise-arc.svg">
    <img src="/images/learning-diagrams/03-g2-clockwise-arc.svg" alt="G2 clockwise arc: I and J locate the arc centre relative to the start point." style="display: block; width: 100%; height: auto; border-radius: 0.75rem;"/>
  </a>
  <figcaption style="margin-top: 0.6rem; font-size: 0.92rem; opacity: 0.82; text-align: center;">Visual guide: I and J locate the arc centre relative to the start point.</figcaption>
</figure>
{:/nomarkdown}
