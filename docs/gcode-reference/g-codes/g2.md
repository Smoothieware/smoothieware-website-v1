...
{::nomarkdown}
<figure id="learning-diagram-03-g2-clockwise-arc" style="scroll-margin-top: 16vh; "clear: both; max-width: 960px; margin: 2rem auto;">
  ...
  <figcaption style="margin-top: 0.6rem; color: #526174; font-size: 0.92rem; text-align: center;">Visual guide: I and J locate the arc centre relative to the start point.</figcaption>
</figure>
{:/nomarkdown}
