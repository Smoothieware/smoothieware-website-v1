...
<!-- learning-diagram:16-g54-work-offset -->
{::nomarkdown}
<figure id="learning-diagram-16-g54-work-offset" style="clear: both; max-width: 960px; margin: 2rem auto; scroll-margin-top: 16vh;">
  <a href="/images/learning-diagrams/16-g54-work-offset.svg">
    <img src="/images/learning-diagrams/16-g54-work-offset.svg" alt="G54 selects work coordinate system 1: The work origin can sit anywhere inside the machine coordinate system." loading="lazy" decoding="async" style="display: block; width: 100%; height: auto; border-radius: 0.1rem;"/>
  </a>
  <figcaption style="margin-top: 0.6rem; font-size: 0.92rem; opacity: 0.82; text-align: center;">G54 selects work coordinate system 1 <a href="#learning-diagram-16-g54-work-offset" aria-label="Permanent link to G54 selects work coordinate system 1" style="margin-left: 0.35rem; text-decoration: none;">#</a></figcaption>
</figure>
{:/nomarkdown}
...
- {::nomarkdown}<gcode>G10</gcode>{:/nomarkdown} - Set WCS offsets via {::nomarkdown}<gcode>G10</gcode>{:/nomarkdown} L2 P[number]
...
- [{::nomarkdown}<gcode>G10</gcode>{:/nomarkdown} - Set Offsets](/g10)
- [{::nomarkdown}<gcode>G53</gcode>{:/nomarkdown} - Use Machine Coordinates](/g53)
- [{::nomarkdown}<gcode>G92</gcode>{:/nomarkdown} - Set Position Offset](/g92)
