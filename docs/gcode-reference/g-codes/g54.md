...
<figure id="learning-diagram-16-g54-work-offset" style="clear: both; max-width: 960px; margin: 2rem auto; scroll-margin-top: 16vh;">
  <a href="/images/learning-diagrams/16-g54-work-offset.svg">
    <img src="/images/learning-diagrams/16-g54-work-offset.svg" alt="G54 work-coordinate offset: Program and machine coordinates are distinct frames." style="display: block; width: 100%; height: auto; border-radius: 0.75rem;"/>
  </a>
  <figcaption style="margin-top: 0.6rem; font-size: 0.92rem; opacity: 0.82; text-align: center;">Visual guide: Program and machine coordinates are distinct frames.</figcaption>
</figure>
{:/nomarkdown}
