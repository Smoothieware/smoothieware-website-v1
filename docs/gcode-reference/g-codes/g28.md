...
<!-- learning-diagram:11-g28-home-or-park -->
{::nomarkdown}
<figure id="learning-diagram-11-g28-home-or-park" style="clear: both; max-width: 960px; margin: 2rem auto; scroll-margin-top: 16vh;">
  <a href="/images/learning-diagrams/11-g28-home-or-park.svg">
    <img src="/images/learning-diagrams/11-g28-home-or-park.svg" alt="G28 depends on GRBL mode: Reprap mode seeks endstops. GRBL mode goes to the recorded machine origin." loading="lazy" decoding="async" style="display: block; width: 100%; height: auto; border-radius: 0.1rem;"/>
  </a>
  <figcaption style="margin-top: 0.6rem; font-size: 0.92rem; opacity: 0.82; text-align: center;">G28 depends on GRBL mode <a href="#learning-diagram-11-g28-home-or-park" aria-label="Permanent link to G28 depends on GRBL mode" style="margin-left: 0.35rem; text-decoration: none;">#</a></figcaption>
</figure>
{:/nomarkdown}
...
For detailed information on Reprap-style homing, see [{::nomarkdown}<gcode>G28</gcode>{:/nomarkdown}-Reprap](g28-reprap).

For detailed information on CNC-style origin movement, see [{::nomarkdown}<gcode>G28</gcode>{:/nomarkdown}-CNC](g28-cnc).



### G28.1: Store Park/Origin Position

See [{::nomarkdown}<gcode>G28.1</gcode>{:/nomarkdown}](g28-1) for full details.
...
- **When {::nomarkdown}<setting v2="general.grbl_mode"></setting>{:/nomarkdown} = false** (Reprap mode): Goes to the park position previously stored by {::nomarkdown}<gcode>G28.1</gcode>{:/nomarkdown}
...
For rotary delta kinematics, {::nomarkdown}<gcode>G28.4</gcode>{:/nomarkdown} sets positions using actuator coordinates rather than cartesian coordinates.
...
- [{::nomarkdown}<gcode>G28</gcode>{:/nomarkdown}-Reprap](g28-reprap) - Detailed info on Reprap-style homing (3D printers)
- [{::nomarkdown}<gcode>G28</gcode>{:/nomarkdown}-CNC](g28-cnc) - Detailed info on CNC-style origin movement
- [{::nomarkdown}<gcode>G28.1</gcode>{:/nomarkdown}](g28-1) - Setting/storing park positions
