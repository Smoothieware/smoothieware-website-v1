...
async function load_and_compile_template() {
  ...
  try {
    ...
    compiled_code_popup_template = import_handlebars.default.compile(template_source);
...
async function load_gcode_mcode_data() {
  ...
  try {
    ...
    const parsed_data = js_yaml_default.load(yaml_text);
...
function setup_related_code_handlers($popup) {
  setTimeout(() => {
    $popup.find(".related-code-button").on("click", function() {
      const related_code = import_jquery.default(this).data("code");
...
import_jquery.default(() => {
  ...
  Promise.all([
    ...
    $gcode_elements.each(function() {
      ...
      create_popup_for_code(import_jquery.default(this), text_content, true);
    ...
    $mcode_elements.each(function() {
      ...
      const html_structure = `<span class="code-content">${colored_content}</span>`;
      import_jquery.default(this).html(html_structure);
      create_popup_for_code(import_jquery.default(this), text_content, false);
