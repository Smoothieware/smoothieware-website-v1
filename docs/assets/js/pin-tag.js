...
// src/site/pin-tag.ts
var compiled_pin_popup_template = null;
var compiled_pin_not_found_template = null;
var compiled_pin_loading_template = null;
...
async function load_and_compile_templates() {
  try {
    ...
    import_handlebars.default.registerHelper("escape", escape_html);
    import_handlebars.default.registerHelper("markdown", render_markdown);
    import_handlebars.default.registerHelper("if_truthy", function(value, options) {
      if (value === true || value === "true") {
        return options.fn(this);
      }
      return options.inverse(this);
    });
    import_handlebars.default.registerHelper("join", function(array, separator) {
...
function create_popup_for_pin($pin_element, pin_name) {
  ...
  const $popup = import_jquery.default(popup_html);
...
async function initialize_pin_tags() {
  try {
    ...
    const $pin_elements = import_jquery.default("pin");
    ...
    $pin_elements.each((index, element) => {
      const $element = import_jquery.default(element);
...
import_jquery.default(document).ready(() => {
  initialize_pin_tags();
});
