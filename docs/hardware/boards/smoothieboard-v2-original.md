---
permalink: /smoothieboard-v2-original
---
...
If you want a Smoothieboard v2, you want the [v2 Prime with STM32H745](smoothieboard-v2-prime).
...
- [Smoothieboard v2 Prime (STM32H745)](smoothieboard-v2-prime) - The current production model (what actually shipped)
- [Smoothieboard v1 Specifications](smoothieboard-v1-specifications) - The proven, lower-cost alternative
