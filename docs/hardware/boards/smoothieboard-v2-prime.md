...
- [ ] Send simple G-code command (e.g., {::nomarkdown}<gcode>G0</gcode>{:/nomarkdown} X10)
...
- [ ] Temperature reading correct (send {::nomarkdown}<mcode>M105</mcode>{:/nomarkdown} command)
