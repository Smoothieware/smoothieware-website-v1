 ...
 */
function is_debug_review_page(): boolean {
 ...
 */
function display_review_data(): void {
    ...
    const reviews = JSON.parse(reviews_raw) as Record<string, unknown>;
 ...
 */
function show_feedback(message: string, variant: 'success' | 'warning' = 'success'): void {
    ...
    setTimeout(() => {
        ...
        if (alert) {
            (alert as HTMLElement & { hide: () => void }).hide();
        }
 ...
 */
function setup_refresh_button(): void {
 ...
 */
function setup_export_button(): void {
 ...
 */
function setup_storage_listener(): void {
 ...
 */
function setup_periodic_refresh(): void {
